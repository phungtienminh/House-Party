...
def update_or_create_user_tokens(session_key, access_token, token_type, expires_time, refresh_token):
    tokens = get_user_tokens(session_key)
    expires_in = timezone.now() + timedelta(seconds=expires_time)
